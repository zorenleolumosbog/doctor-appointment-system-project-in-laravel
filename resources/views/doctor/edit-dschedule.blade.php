...
<div class="main-wrapper">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll" tyle="background-color: blue;">
                    ...
                    <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <div class="cal-icon">
                                        <input class="form-control floating datetimepicker" type="text" name="datefrom"  value = '<?php echo$users[0]->From_date; ?>'   required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    ...
                                    <div class="cal-icon">
                                        <input class="form-control floating datetimepicker" type="text" name="dateto"  value = '<?php echo$users[0]->To_date; ?>'  required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="Doname"  value = '<?php echo$users[0]->Doctor_name; ?>' required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="time-icon">
                                        <input type="text" class="form-control" id="datetimepicker3" name="starttime" value = '<?php echo$users[0]->Start_time; ?>' required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="time-icon">
                                        <input type="text" class="form-control" id="datetimepicker4" name="endtime" value = '<?php echo$users[0]->End_time; ?>' required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Note</label>
                            <textarea cols="30" rows="4" class="form-control" name="note"   value = '<?php echo$users[0]->Note; ?>' required></textarea>
                        </div>
