            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="/schedule-add" class="btn btn-secondary btn-rounded float-right"><i class="fa fa-plus"></i> Add Schedule</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0">
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt="">{{$user->Doctor_name}}</td>
                                        <td>{{$user->Department}}</td>
                                        <td>{{$user->Days}}</td>
                                        <td>{{$user->Start_time}}-{{$user->End_time}}</td>
                                        <td><span class="custom-badge status-green">{{$user->status}}</span></td>
                                        <td class="text-right">
