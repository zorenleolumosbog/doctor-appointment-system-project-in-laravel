...
<div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" action="{{url('Ustore')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <!-- <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Profile ID<span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" name="alt_email">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label>Join Date<span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="jdate">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-secondary submit-btn">Save Details</button>
                            </div>
                        </form>
                    </div>
                </div>
